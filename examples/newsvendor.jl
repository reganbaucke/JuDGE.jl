...
@test newsvendor(depth=2,cost=5.0,price=8.0,demands=[10,20,30],CVaR=(0.15,0.5)) ≈ -61.011 atol = 1e-3
@test newsvendor(depth=3,cost=5.0,price=8.0,demands=[10,20,30],CVaR=(0.15,0.05)) ≈ -90.526 atol = 1e-3
